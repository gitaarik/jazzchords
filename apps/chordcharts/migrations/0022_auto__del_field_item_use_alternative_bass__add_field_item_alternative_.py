...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.use_alternative_bass'
        db.delete_column(u'chordcharts_item', 'use_alternative_bass')

        # Adding field 'Item.alternative_bass'
        db.add_column(u'chordcharts_item', 'alternative_bass',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.use_alternative_bass'
        db.add_column(u'chordcharts_item', 'use_alternative_bass',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Item.alternative_bass'
        db.delete_column(u'chordcharts_item', 'alternative_bass')
