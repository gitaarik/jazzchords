...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Key.tone'
        db.alter_column(u'chordcharts_key', 'tone', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Key.tone'
        db.alter_column(u'chordcharts_key', 'tone', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
