...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Key.key_tone'
        db.add_column(u'chordcharts_key', 'key_tone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Pitch.accidental'
        db.delete_column(u'chordcharts_pitch', 'accidental')


    def backwards(self, orm):
        # Deleting field 'Key.key_tone'
        db.delete_column(u'chordcharts_key', 'key_tone')

        # Adding field 'Pitch.accidental'
        db.add_column(u'chordcharts_pitch', 'accidental',
