...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Section.line_width'
        db.delete_column(u'chordcharts_section', 'line_width')


    def backwards(self, orm):
        # Adding field 'Section.line_width'
        db.add_column(u'chordcharts_section', 'line_width',
