...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pitch.name'
        db.alter_column(u'chordcharts_pitch', 'name', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Pitch.name'
        db.alter_column(u'chordcharts_pitch', 'name', self.gf('django.db.models.fields.CharField')(max_length=1))
