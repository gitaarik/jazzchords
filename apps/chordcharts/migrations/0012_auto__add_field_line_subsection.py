...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.subsection'
        db.add_column(u'chordcharts_line', 'subsection',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='lines', null=True, to=orm['chordcharts.Subsection']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Line.subsection'
        db.delete_column(u'chordcharts_line', 'subsection_id')
    ...
    models = {
        ...
        u'chordcharts.line': {
            ...
            'subsection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lines'", 'null': 'True', 'to': u"orm['chordcharts.Subsection']"})
        },
