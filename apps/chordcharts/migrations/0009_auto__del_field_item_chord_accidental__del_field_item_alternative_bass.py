...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.chord_accidental'
        db.delete_column(u'chordcharts_item', 'chord_accidental')

        # Deleting field 'Item.alternative_bass_tone_accidental'
        db.delete_column(u'chordcharts_item', 'alternative_bass_tone_accidental')


    def backwards(self, orm):
        # Adding field 'Item.chord_accidental'
        db.add_column(u'chordcharts_item', 'chord_accidental',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.alternative_bass_tone_accidental'
        db.add_column(u'chordcharts_item', 'alternative_bass_tone_accidental',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)
