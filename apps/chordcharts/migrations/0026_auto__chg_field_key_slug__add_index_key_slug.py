...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Key.slug'
        db.alter_column(u'chordcharts_key', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=25))
        # Adding index on 'Key', fields ['slug']
        db.create_index(u'chordcharts_key', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Key', fields ['slug']
        db.delete_index(u'chordcharts_key', ['slug'])


        # Changing field 'Key.slug'
        db.alter_column(u'chordcharts_key', 'slug', self.gf('django.db.models.fields.CharField')(max_length=25))
