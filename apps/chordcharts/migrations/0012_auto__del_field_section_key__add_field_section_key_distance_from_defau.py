...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'chordcharts_section', 'key_id')

        # Adding field 'Section.key_distance_from_default'
        db.add_column(u'chordcharts_section', 'key_distance_from_default',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Key.tonality'
        db.add_column(u'chordcharts_key', 'tonality',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Key.distance_from_c'
        db.add_column(u'chordcharts_key', 'distance_from_c',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Chart.key'
        db.add_column(u'chordcharts_chart', 'key',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chordcharts.Key']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Section.key'
        raise RuntimeError("Cannot reverse this migration. 'Section.key' and its values cannot be restored.")
        # Deleting field 'Section.key_distance_from_default'
        db.delete_column(u'chordcharts_section', 'key_distance_from_default')
        ...
        # Deleting field 'Chart.key'
        db.delete_column(u'chordcharts_chart', 'key_id')
    ...
    models = {
        ...
        u'chordcharts.section': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_distance_from_default': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
