...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChordType.chord_output'
        db.add_column(u'chordcharts_chordtype', 'chord_output',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChordType.chord_output'
        db.delete_column(u'chordcharts_chordtype', 'chord_output')
