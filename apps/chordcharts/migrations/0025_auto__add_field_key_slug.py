...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Key.slug'
        db.add_column(u'chordcharts_key', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='slug', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Key.slug'
        db.delete_column(u'chordcharts_key', 'slug')
