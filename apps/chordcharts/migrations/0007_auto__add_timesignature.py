...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeSignature'
        db.create_table(u'chordcharts_timesignature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('beats', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('beat_unit', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'chordcharts', ['TimeSignature'])


    def backwards(self, orm):
        # Deleting model 'TimeSignature'
        db.delete_table(u'chordcharts_timesignature')
