...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.key_distance_from_chart'
        db.add_column(u'chordcharts_section', 'key_distance_from_chart',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Section.key_distance_from_chart'
        db.delete_column(u'chordcharts_section', 'key_distance_from_chart')
