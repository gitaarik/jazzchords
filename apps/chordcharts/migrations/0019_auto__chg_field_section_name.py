...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'chordcharts_section', 'name', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Section.name'
        db.alter_column(u'chordcharts_section', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
