...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.alt_title'
        db.add_column(u'chordcharts_section', 'alt_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.alt_title'
        db.delete_column(u'chordcharts_section', 'alt_title')
