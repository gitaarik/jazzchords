...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'chordcharts_item', u'alternative_bass_tone', u'alternative_bass_pitch')

    def backwards(self, orm):
        db.rename_column(u'chordcharts_item', u'alternative_bass_pitch', u'alternative_bass_tone')
